...
export function SkeletonCard({ className = "" }: { className?: string }) {
  return (
    <div className={`rounded-2xl bg-surface p-4 shadow-card ring-1 ring-line-soft ${className}`}>
...
export function SkeletonStatRow() {
  return (
    <div className="grid grid-cols-3 gap-2.5">
      {[0, 1, 2].map((i) => (
        <div key={i} className="rounded-2xl bg-surface p-3.5 shadow-card ring-1 ring-line-soft">
